...
check:
  ...
  wlist.length() is NUM-BUILTIN-MODULES + 3
  ...
  wlist.get(NUM-BUILTIN-MODULES + 1).locator.uri() is "protocol://bar"
  wlist.get(NUM-BUILTIN-MODULES + 1).locator is string-to-locator("bar")
  wlist.get(NUM-BUILTIN-MODULES + 2).locator is floc
  ...
  wlist2.length() is NUM-BUILTIN-MODULES + 2
  # TODO(joe): this requires some better eval support than we have
