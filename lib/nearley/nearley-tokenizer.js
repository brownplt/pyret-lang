// Basically src/arr/compiler/pyret-tokenizer.js with a few extra functions to
// work with nearley (https://nearley.js.org/docs/tokenizers)
define("nearley/nearley-tokenizer", ["jglr/jglr"], function (E) {
    ...
    Tokenizer.prototype.next = function () {
        const token = GenTokenizer.prototype.next.call(this);
        this.allTokens.push(token.pos);
        if (this.isEOF(token)) {
            return;
        } else {
            return {
    ...
    Tokenizer.prototype.save = function () {
        return {
            ...
            pos: this.pos,
            priorWhitespace: this.priorWhitespace,
            curTok: this.curTok,
            times: this.times,
            skippedWhitespace: this.skippedWhitespace,
            parenIsForExp: this.parenIsForExp,
        };
    }
    ...
    Tokenizer.prototype.reset = function (data, info) {
        ...
        this.whitespace = info.whitespace;
        ...
        this.pos = info.pos;
        this.priorWhitespace = info.priorWhitespace;
        this.curTok = info.curTok;
        this.times = info.times;
        this.skippedWhitespace = info.skippedWhitespace;
        this.parenIsForExp = info.parenIsForExp;
    }
    ...
    return { 'Tokenizer': new Tokenizer(spec) };
});