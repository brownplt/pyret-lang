define(["../../../lib/jglr/jglr"], function(E) {
  ...
  const opcoleq = new RegExp(op("<="), STICKY_REGEXP);
  ...
  const Tokens = [
    ...
    {name: "TABLE", val: new RegExp(kw("table"), STICKY_REGEXP)},
    {name: "ROW", val: new RegExp(kw("row"), STICKY_REGEXP)},
    ...
    {name: "COLASSIGN", val: opcoleq, parenIsForExp: true},
