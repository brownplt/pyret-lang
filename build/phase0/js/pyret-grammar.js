...
R(['fs', '../../../lib/jglr/jglr'], function(fs, E) {
  ...
  g.addRule("opt-comma-binops_I0", [new Nonterm("binop-expr"), new Nonterm("opt-comma-binops_I0_I1_star")], E.Rule.Inline)
  g.addRule("opt-comma-binops_I0_I1_star", [], E.Rule.Inline);
  g.addRule("opt-comma-binops_I0_I1_star", [new Nonterm("opt-comma-binops_I0_I1_star"), new Nonterm("opt-comma-binops_I0_I1")], E.Rule.ListSnoc("opt-comma-binops_I0_I1_star", "opt-comma-binops_I0_I1", true));
  g.addRule("opt-comma-binops_I0_I1", [new Token("COMMA"), new Nonterm("binop-expr")], E.Rule.Inline)
  ...
  g.addRule("construct-expr", [new Token("LBRACK"), new Nonterm("construct-modifier"), new Nonterm("binop-expr"), new Token("COLON"), new Nonterm("opt-comma-binops"), new Token("RBRACK")])
  ...
  g.addRule("table-order", [new Token("TABLE-ORDER"), new Nonterm("expr"), new Token("COLON"), new Nonterm("column-order"), new Token("END")])
  ...
  g.addRule("record-ann_I1", [new Nonterm("ann-field"), new Nonterm("record-ann_I1_I1_star")], E.Rule.Inline)
  g.addRule("record-ann_I1_I1_star", [], E.Rule.Inline);
  g.addRule("record-ann_I1_I1_star", [new Nonterm("record-ann_I1_I1_star"), new Nonterm("record-ann_I1_I1")], E.Rule.ListSnoc("record-ann_I1_I1_star", "record-ann_I1_I1", true));
  g.addRule("record-ann_I1_I1", [new Token("COMMA"), new Nonterm("ann-field")], E.Rule.Inline)
