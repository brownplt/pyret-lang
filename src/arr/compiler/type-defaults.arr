...
fun make-default-typs():
  ...
  default-typs.set-now(A.s-global("num-within").key(), t-top)
  default-typs.set-now(A.s-global("num-within-abs").key(), t-top)
  default-typs.set-now(A.s-global("num-within-rel").key(), t-top)
  ...
  default-typs.set-now(A.s-global("within").key(), t-top)
  default-typs.set-now(A.s-global("within-abs").key(), t-top)
  default-typs.set-now(A.s-global("within-rel").key(), t-top)
  default-typs.set-now(A.s-global("within-now").key(), t-top)
  default-typs.set-now(A.s-global("within-abs-now").key(), t-top)
  default-typs.set-now(A.s-global("within-rel-now").key(), t-top)
