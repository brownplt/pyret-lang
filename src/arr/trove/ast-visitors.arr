...
shadow default-map-visitor =
  {
    ...
    method prim-app-info-c(self, needs-step): prim-app-info-c(needs-step) end,
    ...
    method s-contract(self, l, name, params, ann):
      s-contract(l, name.visit(self), self.list(params), ann.visit(self))
    end,
    ...
    method s-prim-app(self, l, _fun, args, app-info):
      s-prim-app(l, _fun, self.list(args), app-info.visit(self))
    end,
...
shadow default-iter-visitor =
  {
    ...
    method prim-app-info-c(self, needs-step): true end,
    method s-program(self, l, _provide, provided-types, imports, block):
      _provide.visit(self)
      and
    ...
    method s-prim-app(self, l, _fun, args, app-info):
      self.list(args) and app-info.visit(self)
    end,
...
shadow dummy-loc-visitor =
  {
    ...
    method s-prim-app(self, l, _fun, args, app-info):
      s-prim-app(dummy-loc, _fun, self.list(args), app-info.visit(self))
    end,
