define(["js/namespace", "trove/image", "trove/world", "js/js-numbers"], function(Namespace, imageLib, worldLib, jsnums) {
  ...
  function makeBootstrapNamespace(rt) {
    ...
    var n = Namespace.namespace({
      ...
      'max': rt.namespace.get("max"),
      'min': rt.namespace.get("min"),
      'abs': rt.namespace.get("abs"),
      'sin': rt.namespace.get("sin"),
      'cos': rt.namespace.get("cos"),
      'tan': rt.namespace.get("tan"),
      'asin': rt.namespace.get("asin"),
      'acos': rt.namespace.get("acos"),
      'atan': rt.namespace.get("atan"),
      'modulo': rt.namespace.get("modulo"),
      'truncate': rt.namespace.get("truncate"),
      'sqrt': rt.namespace.get("sqrt"),
      'sqr': rt.namespace.get("sqr"),
      'ceiling': rt.namespace.get("ceiling"),
      'floor': rt.namespace.get("floor"),
      'log': rt.namespace.get("log"),
      'exp': rt.namespace.get("exp"),
      'exact': rt.namespace.get("exact"),
      'is-integer': rt.namespace.get("is-integer"),
      'expt': rt.namespace.get("expt"),
