  ...
  postLoadHooks[main] = function(answer) {
    ...
    runtime.safeCall(function() {
      ...
      if(runtime.isObject(summary)) {
        ...
        var summaryStringified = JSON.stringify(summaryJSON, null, "\t");
        process.stdout.write(summaryStringified + "\n");
        var errs = summaryJSON.errored;
        var failed = summaryJSON.failed;
        if(errs !== 0 || failed !== 0) {
