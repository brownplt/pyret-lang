...
runtime-builtins = [string-dict:
  ...
  "string-less", T.t-top,
  "string-greater", T.t-top,
  "string-less-equal", T.t-top,
  "string-greater-equal", T.t-top,
  "string-ci-equal", T.t-top,
  "string-ci-less", T.t-top,
  "string-ci-greater", T.t-top,
  "string-ci-less-equal", T.t-top,
  "string-ci-greater-equal", T.t-top,
