...
@docmodule["lists"]{
  ...
  @ignore[(list "list")]
  @para{This should link to @secref[(tag-name "lists" "link" "length")] and @secref[(tag-name "lists" "List")] and @secref[(tag-name "lists" "empty")] and @secref[(tag-name "lists" "link")]}
  @section{Re-exported values}
  ...
  @function[
    ...
    #:contract
    (a-arrow
      (a-arrow "Any" (list "Bool" (xref "<global>" "Bool")))
      (a-id "List" (xref "lists" "List"))
  ...
  @function[
    ...
    (a-arrow
      ...
      (a-id "List" (xref "lists" "List"))
      (a-id "Bool" (xref "<global>" "Bool")))
    #:args '(("joiner" #f) ("the-list" "It's a list!"))
  ]{
