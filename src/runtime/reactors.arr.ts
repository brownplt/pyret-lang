...
type Reactor<A> = {
    ...
    interact: () => Reactor<A>,
    $interact: (insertNode?: (node: any, setupClose: (close: () => void) => void) => void) => Reactor<A>,
    $interactNoPauseResume: (insertNode?: (node: any, setupClose: (close: () => void) => void) => void) => Reactor<A>,
    $shutdown: () => void,
