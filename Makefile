...
COMPILER_FILES = $(wildcard src/arr/compiler/*.arr) $(wildcard src/arr/desugar/*.arr) $(wildcard src/arr/compiler/locators/*.arr) $(wildcard src/js/trove/*.js) $(wildcard src/arr/trove/*.arr)
