...
//    out.write("console.log(__dirname);\n");
    ...
    // TODO: Use new syntax
    out.write("  out.write(\"({\\n\");\n");
    out.write("  out.write(\"provides: {},\");\n");
    out.write("  out.write(\"requires: [],\");\n");
    out.write("  out.write(\"nativeRequires: [\");\n");
    out.write("  out.write(\"\\\"jglr/jglr\\\"\");\n");
    out.write("  out.write(\"],\\n\");\n");

    out.write("  out.write(\"/** @param {{Grammar : {fromSerializable : !Function}, Nonterm : !Object, Token : !Object, Rule : !Object}} E */\\n\");\n");
    out.write("  out.write(\"theModule: function(runtime, ns, uri, E) {\\n\");\n");
    ...
    out.write("  out.write(\"  return runtime.makeModuleReturn({ " + bnfJS.config.name + ": Grammar.fromSerializable(g_json) }, {});\\n\");\n");
    out.write("  out.write(\"}\\n\");\n");
    out.write("  out.write(\"})\\n\");\n");
    out.write("  out.end();\n");
    out.write("});\n");
