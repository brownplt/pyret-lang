({
  ...
  provides: {
    ...
    values: {
      ...
      "fill": ["arrow", [["List", "Integer"], "Number"], "Tensor"],
      "tensor": ["Maker", "Number", ["local", "Tensor"]],
      "linspace": ["arrow", ["Number", "Number", "Number"], "Tensor"],
      "ones": ["arrow", [["List", "Integer"]], "Tensor"],
      "zeros": ["arrow", [["List", "Integer"]], "Tensor"],
      "multinomial": ["arrow", ["Tensor", "Number", ["Option", "Number"], "Boolean"], "Tensor"],
      "random-normal": ["arrow", [["List", "Integer"], ["Option", "Number"], ["Option", "Number"]], "Tensor"],
      "random-uniform": ["arrow", [["List", "Integer"], ["Option", "Number"], ["Option", "Number"]], "Tensor"],
