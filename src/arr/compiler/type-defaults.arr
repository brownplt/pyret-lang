...
module-const-error = t-module("pyret-builtin://error",
  t-record([list:
    ...
    t-member("cases-arity-mismatch", t-arrow([list: t-top, t-top, t-top, t-top], t-name(some("pyret-builtin://error"), A.s-global("RuntimeError")))),
    ...
    .set("RuntimeError",
      t-datatype("RuntimeError",
        ...
        [list:
          ...
          t-variant(SL.srcloc("src/arr/base/error.arr", 55, 4, 2504, 55, 60, 2560), "cases-arity-mismatch", [list: t-member("branch-loc", t-top), t-member("num-args", t-top), t-member("actual-arity", t-top), t-member("cases-loc", t-top)], empty),
          t-variant(SL.srcloc("src/arr/base/error.arr", 61, 4, 2854, 61, 72, 2922), "cases-singleton-mismatch", [list: t-member("branch-loc", t-top), t-member("should-be-singleton", t-boolean), t-member("cases-loc", t-top)], empty),
