...
fun make-default-types() block:
  ...
  default-typs.set-now(A.s-global("raw-array-from-list").key(), t-forall([list: tva], t-arrow([list: t-app(t-list, [list: tva])], t-array(tva))))
  default-typs.set-now(A.s-global("raw-array-join-str").key(), t-arrow([list: t-array(t-string), t-string], t-string))
  ...
  default-typs.set-now(A.s-global("string-split").key(), t-arrow([list: t-string, t-string], t-app(t-list, [list: t-string])))
  default-typs.set-now(A.s-global("string-split-all").key(), t-arrow([list: t-string, t-string], t-app(t-list, [list: t-string])))
  default-typs.set-now(A.s-global("string-explode").key(), t-arrow([list: t-string], t-app(t-list, [list: t-string])))
  default-typs.set-now(A.s-global("string-index-of").key(), t-arrow([list: t-string, t-string], t-number))
  default-typs.set-now(A.s-global("string-to-code-points").key(), t-arrow([list: t-string], t-app(t-list, [list: t-number])))
  default-typs.set-now(A.s-global("string-from-code-points").key(), t-arrow([list: t-app(t-list, [list: t-number])], t-string))
