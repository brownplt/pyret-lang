define(["js/runtime-util", "js/js-numbers", "trove/image-lib", "trove/d3-lib",
  ...
  return function(rt, namespace) {
    ...
    function forceLayout(rawGraph) {
      ...
      var vertexPrinter = gf(
        graphOptions, "vertex-printer").app;
      var edgePrinter = gf(
        graphOptions, "edge-printer").app;
    ...
    return util.makeModuleReturn(rt, {}, {
      "tree-diagram": rt.makeFunction(treeDiagram),
      "force-layout": rt.makeFunction(forceLayout)
    });
  };
});