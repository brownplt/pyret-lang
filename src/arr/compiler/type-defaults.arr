...
module-const-error = t-module("builtin://error",
  t-record([string-dict:
    ...
    "parse-error-bad-denominator", t-arrow([list: t-top], t-parse-error),
    "is-parse-error-bad-denominator", t-arrow([list: t-top], t-boolean),
  ...
  SD.make-string-dict()
    ...
    .set("ParseError", t-data(
      ...
      [list:
        ...
        t-variant("parse-error-bad-denominator", [list: {"loc"; t-top}, {"next-token"; t-string}], [string-dict: ]),
