...
(defsubst pyret-TYPE-LET () (pyret-keyword "type-let"))
...
(defvar pyret-nestings-dirty-at-char (point-min)
        ...
        (while (not (eolp))
          (cond
             ...
             ((looking-at ".*|#")
              (cond
               ((> (pyret-indent-block-comment-depth cur-opened) 0) 
                (cl-decf (pyret-indent-block-comment-depth cur-opened)))
               ((> (pyret-indent-block-comment-depth defered-opened) 0)
                (cl-decf (pyret-indent-block-comment-depth defered-opened)))
               ((looking-at "[ \t]*|#")
                (cl-incf (pyret-indent-block-comment-depth cur-closed)))
               (t 
                (cl-incf (pyret-indent-block-comment-depth defered-closed))))
              (goto-char (match-end 0)))
             ((pyret-BLOCK-COMMENT)
              (cl-incf (pyret-indent-block-comment-depth defered-opened))
              (goto-char (match-end 0)))
             (t
              (end-of-line)))
            )
           ...
           ((and (pyret-FROM) (pyret-has-top opens '(provide)))
            ...
            (forward-char 4))
           ((and (looking-at pyret-initial-operator-regex) (not (pyret-in-string)))
            (cl-incf (pyret-indent-initial-period cur-opened))
            (cl-incf (pyret-indent-initial-period defered-closed))
            (goto-char (match-end 0)))
           ((pyret-COLON)
            (cond
             ...
             ((or (pyret-has-top opens '(object))
              ...
              (when (or (pyret-has-top opens '(braced-expr))
                ...
                (pop opens)
                (push 'object opens))
              (cl-incf (pyret-indent-fields defered-opened))
              (push 'field opens)
            ...
            (when (pyret-has-top opens '(field))
              ...
              (cond ;; if a field was just opened (or will be opened), ignore it
               ((> (pyret-indent-fields cur-opened) 0) 
                ...
                (cl-decf (pyret-indent-fields cur-opened)))
               ((> (pyret-indent-fields defered-opened) 0)
                ;;(message "In comma, defered-opened-fields > 0, decrementing")
                (cl-decf (pyret-indent-fields defered-opened)))
               (t 
                ;;(message "In comma, incrementing defered-closed-fields")
                (cl-incf (pyret-indent-fields defered-closed))))) ;; otherwise decrement the running count
            (forward-char))
           ((pyret-EQUALS)
            (cond
             ((pyret-has-top opens '(wantcolonorequal))
           ...
           ((or (pyret-FUN) (pyret-LAM))
            (cl-incf (pyret-indent-fun defered-opened))
            (push 'fun opens)
           ...
           ((pyret-CASES)
            (cl-incf (pyret-indent-cases defered-opened))
            (push 'cases opens)
            (push 'wantcolonorblock opens)
            (push 'needsomething opens)
            (push 'wantcloseparen opens)
           ...
           ((and (pyret-DATA) (not (pyret-has-top opens '(new-provide))) (not (pyret-has-top opens '(import))))
            (cl-incf (pyret-indent-data defered-opened))
            (push 'data opens)
            (push 'wantcolon opens)
            (push 'needsomething opens)
            (forward-char 4))
           ...
           ((pyret-ELSEIF)
            (when (pyret-has-top opens '(if))
              (cond
               ((> (pyret-indent-fun cur-opened) 0) (cl-decf (pyret-indent-fun cur-opened)))
               ((> (pyret-indent-fun defered-opened) 0) (cl-decf (pyret-indent-fun defered-opened)))
               (t (cl-incf (pyret-indent-fun cur-closed))))
              (cl-incf (pyret-indent-fun defered-opened))
              (push 'wantcolon opens)
              (push 'needsomething opens))
            (forward-char 7))
           ...
           ((pyret-PIPE)
            (cond 
             ((or (pyret-has-top opens '(object data))
              ...
              ;(cl-incf (pyret-indent-object cur-closed))
              (cond
               ((pyret-has-top opens '(field))
                ...
                (cond ;; if a field was just opened (or will be opened), ignore it
                 ...
                 (t 
                  ...
                  (cl-incf (pyret-indent-fields cur-closed)))))) ;; otherwise decrement the running count
           ...
           ((pyret-WITH)
            (cond
             ((pyret-has-top opens '(wantopenparen wantcloseparen data))
              (pop opens) (pop opens)
              ;(cl-incf (pyret-indent-object defered-opened))
              (push 'object opens)
              (push 'wantcolon opens))
             ((pyret-has-top opens '(data))
              ;(cl-incf (pyret-indent-object defered-opened))
           ...
           ((pyret-PROVIDE)
             (push 'provide opens)
             (cl-incf (pyret-indent-shared defered-opened))
             (forward-char 7))
           ((pyret-IMPORT)
            (push 'import opens)
           ...
           ((and (pyret-AS) (pyret-has-top opens '(wantcolonoras import)))
            ...
            (cond
             ((> (pyret-indent-shared cur-opened) 0)
              (cl-decf (pyret-indent-shared cur-opened)))
             ((> (pyret-indent-shared defered-opened) 0)
              (cl-decf (pyret-indent-shared defered-opened)))
             (t
              (cl-incf (pyret-indent-shared defered-closed))))
            (forward-char 2))
           ((pyret-SHARING)
            (cl-incf (pyret-indent-data cur-closed))
            (cl-incf (pyret-indent-shared defered-opened))
            (cond 
             ((pyret-has-top opens '(field object data))
           ...
           ((pyret-WHERE)
            (cond
             ...
             ((pyret-has-top opens '(fun))
              (pop opens)
              (cl-incf (pyret-indent-fun cur-closed))
              (cl-incf (pyret-indent-shared defered-opened)))
             ((pyret-has-top opens '(shared))
              (pop opens)
              (cl-incf (pyret-indent-shared cur-closed))
              (cl-incf (pyret-indent-shared defered-opened)))
             ((not opens)
              (cl-incf (pyret-indent-shared defered-opened))))
            (push 'check opens)
           ...
           ((and (pyret-EXAMPLES) (not opens))
            ...
            (forward-char 8))
           ((pyret-TRY)
            (cl-incf (pyret-indent-try defered-opened))
            (push 'try opens)
            (push 'wantcolon opens)
            (forward-char 3))
           ((pyret-BLOCK)
           ...
           ((pyret-ORDER)
            ...
            (forward-char 5))
           ((pyret-GRAPH)
            (cl-incf (pyret-indent-graph defered-opened))
            (push 'graph opens)
            (push 'wantcolon opens)
            (forward-char 5))
           ((pyret-EXCEPT)
            (cond 
             ((> (pyret-indent-try cur-opened) 0) 
              (cl-decf (pyret-indent-try cur-opened)) (cl-incf (pyret-indent-except cur-opened)))
             ((> (pyret-indent-try defered-opened) 0)
              (cl-decf (pyret-indent-try defered-opened)) (cl-incf (pyret-indent-except defered-opened)))
             (t 
              (cl-incf (pyret-indent-try cur-closed)) (cl-incf (pyret-indent-except defered-opened))))
            ...
            (forward-char 6))
           ;; ((LANGLE)
           ;;  (cl-incf open-parens) (cl-incf cur-opened-parens)
           ;;  (push 'angle opens)
           ;;  (forward-char))
           ;; ((RANGLE)
           ;;  (cl-decf open-parens) (cl-incf cur-closed-parens)
           ...
           ((pyret-RBRACE)
            ...
            (forward-char))
           ((pyret-LPAREN)
            (cl-incf (pyret-indent-parens defered-opened))
            (cond
           ...
           ((pyret-RPAREN)
            (cond
             ((> (pyret-indent-parens cur-opened) 0) (cl-decf (pyret-indent-parens cur-opened)))
             ((> (pyret-indent-parens defered-opened) 0) (cl-decf (pyret-indent-parens defered-opened)))
             (t (cl-incf (pyret-indent-parens defered-closed))))
           ...
           ((pyret-END)
            (cond ((pyret-has-top opens '(field object data))
                   (pop opens)
                   (pop opens)
                   (cl-incf (pyret-indent-fields cur-closed)))
                  ((pyret-has-top opens '(object data))
                   (pop opens))
              ...
              (while (and still-unclosed opens)
                (cond
                 ...
                 ((or (equal h 'object) (equal h 'array))
                  (cond 
                   ((> (pyret-indent-object cur-opened) 0) (cl-decf (pyret-indent-object cur-opened)))
                   ((> (pyret-indent-object defered-opened) 0) (cl-decf (pyret-indent-object defered-opened)))
                   (t (cl-incf (pyret-indent-object cur-closed)))))
                 ((equal h 'wantcloseparen)
                  (cond
                   ((> (pyret-indent-parens cur-opened) 0) (cl-decf (pyret-indent-parens cur-opened)))
                   ((> (pyret-indent-parens defered-opened) 0) (cl-decf (pyret-indent-parens defered-opened)))
                   (t (cl-incf (pyret-indent-parens cur-closed)))))
                 ((equal h 'field)
                  (cond
                   ((> (pyret-indent-fields cur-opened) 0) (cl-decf (pyret-indent-fields cur-opened)))
                   ((> (pyret-indent-fields defered-opened) 0) (cl-decf (pyret-indent-fields defered-opened)))
                   (t (cl-incf (pyret-indent-fields cur-closed)))))
                 ((equal h 'var)
                  (cond
                   ((> (pyret-indent-vars cur-opened) 0) (cl-decf (pyret-indent-vars cur-opened)))
                   ((> (pyret-indent-vars defered-opened) 0) (cl-decf (pyret-indent-vars defered-opened)))
                   (t (cl-incf (pyret-indent-vars cur-closed)))))
                 ((or (equal h 'new-provide) (equal h 'import))
                  (cond
                   ((> (pyret-indent-shared cur-opened) 0) (cl-decf (pyret-indent-shared cur-opened)))
                   ((> (pyret-indent-shared defered-opened) 0) (cl-decf (pyret-indent-shared defered-opened)))
                   (t (cl-incf (pyret-indent-shared cur-closed)))))
                 ((equal h 'provide)
                  (cond
                   ((> (pyret-indent-vars cur-opened) 0) (cl-decf (pyret-indent-vars cur-opened)))
                   ((> (pyret-indent-vars defered-opened) 0) (cl-decf (pyret-indent-vars defered-opened)))
                 ...
                 ((or (equal h 'cases) (equal h 'ifcond))
                  (cond
                   ((> (pyret-indent-cases cur-opened) 0) (cl-decf (pyret-indent-cases cur-opened)))
                   ((> (pyret-indent-cases defered-opened) 0) (cl-decf (pyret-indent-cases defered-opened)))
                   (t (cl-incf (pyret-indent-cases cur-closed))))
                  (setq still-unclosed nil))
                 ((equal h 'data)
                  (cond
                   ((> (pyret-indent-data cur-opened) 0) (cl-decf (pyret-indent-data cur-opened)))
                   ((> (pyret-indent-data defered-opened) 0) (cl-decf (pyret-indent-data defered-opened)))
                   (t (cl-incf (pyret-indent-data cur-closed))))
                  (setq still-unclosed nil))
                 ...
                 ((equal h 'try)
                  (cond
                   ((> (pyret-indent-try cur-opened) 0) (cl-decf (pyret-indent-try cur-opened)))
                   ((> (pyret-indent-try defered-opened) 0) (cl-decf (pyret-indent-try defered-opened)))
                   (t (cl-incf (pyret-indent-try cur-closed))))
                  (setq still-unclosed nil))
                 ((equal h 'except)
                  (cond
                   ((> (pyret-indent-except cur-opened) 0) (cl-decf (pyret-indent-except cur-opened)))
                   ((> (pyret-indent-except defered-opened) 0) (cl-decf (pyret-indent-except defered-opened)))
                   (t (cl-incf (pyret-indent-except cur-closed))))
                  (setq still-unclosed nil))
                 ((equal h 'graph)
                  (cond
                   ((> (pyret-indent-graph cur-opened) 0) (cl-decf (pyret-indent-graph cur-opened)))
                   ((> (pyret-indent-graph defered-opened) 0) (cl-decf (pyret-indent-graph defered-opened)))
                   (t (cl-incf (pyret-indent-graph cur-closed))))
                  (setq still-unclosed nil))
                 )
                (pop opens)
...
(defun pyret-mode ()
  ...
  (set (make-local-variable 'pyret-nestings-dirty-at-char) (point-min))
